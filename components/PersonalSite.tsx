...
export default function PersonalSite() {
  ...
  // styles
  const card =
    "rounded-[28px] border border-white/10 p-6 bg-white/8 dark:bg-white/5 backdrop-blur shadow-2xl shadow-black/10 dark:shadow-black/40";
  const btn =
            ...
            <motion.div className="md:col-span-8 text-zinc-300" initial={fadeUp.initial} animate={fadeUp.animate}>
              ...
              <div className="mt-4 flex flex-wrap gap-2 text-xs">
                <span className="inline-flex items-center gap-1 rounded-full border border-white/10 bg-white/5 px-2 py-1">
                  <GraduationCap className="h-3.5 w-3.5" /> ASU — BS CS ’25
                </span>
                <span className="inline-flex items-center gap-1 rounded-full border border-white/10 bg-white/5 px-2 py-1">
                  <Award className="h-3.5 w-3.5" /> Dean’s List (GPA 3.75)
                </span>
                <span className="inline-flex items-center gap-1 rounded-full border border-white/10 bg-white/5 px-2 py-1">
                  <GraduationCap className="h-3.5 w-3.5" /> ASU — MCS Big Data Systems ’26
                </span>
              </div>
            </motion.div>
          </div>
