  ...
  return (
    <section id="now" className="mx-auto max-w-6xl px-4 py-10 md:py-14">
      <div className="flex items-baseline gap-3">
        <h2
          className={`section-title ${titleGrad} text-xl md:text-2xl font-semibold tracking-tight`}
          style={{ ["--hlw" as any]: "140px" }}
        >
          Now
        </h2>
      ...
      <div
        className={`mt-6 grid gap-6 ${sidebar ? "lg:grid-cols-[1.15fr_0.85fr]" : ""}`}
      >
        <div className="rounded-[28px] ring-1 ring-white/10 p-5 bg-white/[0.04] backdrop-blur">
